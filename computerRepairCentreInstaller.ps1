...
function download {
	...
	$psCmd = [powershell]::Create().AddScript({
			...
			$anyDeskURL = "https://github.com/charliehoward/NorthPoint-Installer/raw/master/assets/anyDesk.ico"
...
function computerRepairCentreInstaller {
	...
	$handler_install_Click =
	{
		...
		$processRunspace.SessionStateProxy.SetVariable("syncHash",$syncHash)
		$psCmd = [powershell]::Create().AddScript({
				$syncHash.progress.Items.Add("Current version: 5.2023.04.29.0")
				$syncHash.progress.SelectedIndex = $syncHash.progress.Items.Count - 1;
				$syncHash.progress.SelectedIndex = -1;
				$syncHash.progress.Items.Add("Last updated: 29th of April 2023")
				$syncHash.progress.SelectedIndex = $syncHash.progress.Items.Count - 1;
				$syncHash.progress.SelectedIndex = -1;
				if ($birthday -like '*1*') { 
	...
	$crcInstaller.Text = "Computer Repair Centre Installer 5.2023.04.29.0"
