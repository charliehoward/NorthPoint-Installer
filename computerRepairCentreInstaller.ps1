...
function computerRepairCentreInstaller {
	...
	$handler_install_Click =
	{
		...
		$processRunspace.SessionStateProxy.SetVariable("syncHash",$syncHash)
		$psCmd = [powershell]::Create().AddScript({
				$syncHash.progress.Items.Add("Current version: 4.2022.10.15.0")
				...
				if ($syncHash.microsoftOffice2021.Checked) {
					...
					$syncHash.progress.SelectedIndex = $syncHash.progress.Items.Count - 1;
					$syncHash.progress.SelectedIndex = -1;
					Invoke-RestMethod -Uri "https://files.crchq.net/installer/Office2021Part1.zip" -OutFile "C:\Computer Repair Centre\Office2021.zip"
					& 'C:\Program Files\7-Zip\7z.exe' x "C:\Computer Repair Centre\Office2021Part1.zip" "-oC:\Computer Repair Centre\Office2021" -aoa
					Invoke-RestMethod -Uri "https://files.crchq.net/installer/Office2021Part2.zip" -OutFile "C:\Computer Repair Centre\Office2021.zip"
					& 'C:\Program Files\7-Zip\7z.exe' x "C:\Computer Repair Centre\Office2021Part2.zip" "-oC:\Computer Repair Centre\Office2021" -aoa
					Invoke-RestMethod -Uri "https://files.crchq.net/installer/Office2021Part3.zip" -OutFile "C:\Computer Repair Centre\Office2021.zip"
	...
	$crcInstaller.Text = "Computer Repair Centre Installer 4.2022.10.15.0"
